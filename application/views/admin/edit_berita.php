...
<div class="box box-info">
                ...
                <!-- form start -->
                <form action="<?php echo base_url(); ?>admin/tambah_berita/prosesedit_berita" enctype="multipart/form-data" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <div class="box-body">
