...
<section class="content-header">
    <h1>
        Staf Pengajar
        <small>Form Tambah Staf</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Staf</a></li>
        <li class="active">Tambah Staf Pengajar</li>
    </ol>
<div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Tambahkan Staf Pengajar</h3>
                  <?php 
                    if ($error == "error") { ?>
                ...
                <form action="<?php echo base_url('admin/staf/proses_tambah'); ?>" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="nama_lengkap" value="<?php echo set_value('nama_lengkap') ?>" class="form-control" id="judul" placeholder="Masukkan Nama Lengkap" required/>
                    ...
                    <?php echo form_error('foto'); ?>
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="bidang" value="<?php echo set_value('bidang') ?>" class="form-control">
