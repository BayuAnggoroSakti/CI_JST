 ...
 $i=1; foreach ($data_get as $row) {
  ...
  ?>
        <tr>
          ...
          <td>
          <a href="<?php echo base_url();?>admin/tambah_berita/editBerita/<?php echo $row->id_berita; ?>" >
              <button type="button" class="btn btn-primary">Edit</button>
          </a>
          <a href="<?php echo base_url();?>admin/tambah_berita/hapus_berita/<?php echo $row->id_berita; ?>" onclick="return confirm('Menghapus Berita ini ?')">
