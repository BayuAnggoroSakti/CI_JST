  ...
  <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/tambah_kategori_berita/tambah_kategori_berita'); ?>">
                  <div class="box-body">
               ...
               <div class="box-body table-responsive no-padding">
                  ...
                  <?php 
                    ...
                    <tr>
                      ...
                      <td>
                          <a href="<?php echo base_url();?>admin/tambah_kategori_berita/edit_katBer/<?php echo $row->id_katBer; ?>" >
                              <button type="button" class="btn btn-primary">Edit</button>
                          </a>
                          <a href="<?php echo base_url();?>admin/tambah_kategori_berita/edit_katBer/<?php echo $row->id_katBer; ?>" onclick="return confirm('Menghapus Berita ini ?')">
