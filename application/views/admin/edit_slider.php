...
<div class="box box-info">
                ...
                <!-- form start -->
                <form action="<?php echo base_url('admin/dashboard/slider_proses_edit'); ?>" onsubmit="return Checkfiles();" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <div class="box-body">
                  <input type="hidden" name="id_slider" value="<?php echo $data_get->id_slider ?>"></input>
                    <div class="form-group">
                      <label for="inputPassword3" class="col-sm-2 control-label">Gambar</label>
                      <div class="col-sm-10">
                        <img id="thumb_image" height="200px" width="200px" src="<?php echo base_url('assets/images/')."/".$data_get->gambar ?>"/><br /><br />
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="deskripsi" value="<?php echo $data_get->deskripsi ?>" required class="form-control" id="inputPassword3" placeholder="Deskripsi slider">
                      </div>
                    </div>
