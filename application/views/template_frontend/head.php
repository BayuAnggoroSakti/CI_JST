...
<head>
	<title>Jogja Science Training</title>
...
<link rel="stylesheet" media="screen" href="<?php echo base_url('assets/admin/AdminLTE-2.0.5/plugins/datatables/dataTables.bootstrap.css') ?>" type="text/css"/>
	...
	<script type="text/javascript" src="<?php echo base_url('assets/js/DevSolutionSkill.min.js') ?>"></script>
