...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 13, 2016 at 07:21 PM
...
(22, 1, 2, 'cdcd', '<p>hmghm</p>\r\n', '2016-03-13', 'n', 'cdcd.jpg');
...
(364, 1457892309, '::1', '3639'),
(365, 1457892319, '::1', '5668'),
(366, 1457893059, '::1', '6928'),
(367, 1457893086, '::1', '5369');
...
(15, 1, 'Pembinaan Persiapan OSK', 'SMA N 1 Cepu', '2015-12-13', '2015-12-15', 'embinaan Persiapan OSK di SMA N 1 Cepu 13-15 Desember 2015\r\n');
...
(12, 'Pembinaan OSP', '5 juta per bidang (minimal 4 siswa)', 'JST Yogyakarta', '4 hari, per hari 7 jam', 'Modul, Penginapan, Transportasi lokal, tur UGM dan Jogja', 'Peserta ditargetkan menguasai materi dan lolos OSP'),
...
--
ALTER TABLE `captcha`
MODIFY `captcha_id` bigint(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=368;
--
-- AUTO_INCREMENT for table `detail`
--
ALTER TABLE `detail`
MODIFY `id_detail` int(4) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=41;
--
...
--
ALTER TABLE `kategori_berita`
MODIFY `id_katBer` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `materi`
MODIFY `id_materi` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=24;
--
...
--
ALTER TABLE `staf_pengajar`
MODIFY `id_staf` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `tryout`
--
ALTER TABLE `tryout`
MODIFY `id_to` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
...
ADD CONSTRAINT `berita_ibfk_3` FOREIGN KEY (`id_kateBer`) REFERENCES `kategori_berita` (`id_katBer`) ON UPDATE CASCADE;
...
--
ALTER TABLE `foto`
ADD CONSTRAINT `foto_ibfk_1` FOREIGN KEY (`id_gallery`) REFERENCES `gallery` (`id_gallery`) ON UPDATE CASCADE;

--
-- Constraints for table `gallery`
--
ALTER TABLE `gallery`
ADD CONSTRAINT `gallery_ibfk_1` FOREIGN KEY (`id_pelatihan`) REFERENCES `pelatihan` (`id_pelatihan`) ON UPDATE CASCADE;

--
-- Constraints for table `pelatihan`
--
ALTER TABLE `pelatihan`
ADD CONSTRAINT `pelatihan_ibfk_1` FOREIGN KEY (`id_programKerja`) REFERENCES `program_kerja` (`id_programKerja`) ON UPDATE CASCADE;

--
-- Constraints for table `pelatihan_staf`
--
ALTER TABLE `pelatihan_staf`
ADD CONSTRAINT `pelatihan_staf_ibfk_1` FOREIGN KEY (`id_staf`) REFERENCES `staf_pengajar` (`id_staf`) ON UPDATE CASCADE,
ADD CONSTRAINT `pelatihan_staf_ibfk_2` FOREIGN KEY (`id_pelatihan`) REFERENCES `pelatihan` (`id_pelatihan`) ON UPDATE CASCADE;
